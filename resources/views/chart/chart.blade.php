...
<head>
    ...
    <!-- Typekit fonts -->
    <script src="//use.typekit.net/uva4etg.js"></script>
    <script>try {
            Typekit.load();
        } catch (e) {
        }</script>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">New Chart</a></li>
                        <li><a href="#">Open Chart</a></li>
                        <li><a href="#">Recent Charts</a></li>
                        <li><a href="#">Save Chart</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Subjective<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a class="page-scroll" href="#patient_info">Patient Info</a></li>
                        <li><a class="page-scroll" href="#cc">Chief Complaint</a></li>
                        <li><a href="#">HPI</a></li>
                        <li><a href="#">ROS</a></li>
                        <li><a href="#">PMH</a></li>
                        <li><a href="#">PSH</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Objective <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Assessment<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">DDX</a></li>
                        <li><a href="#">ED Course</a></li>
                        <li><a href="#">Procedures</a></li>
                        <li><a href="#">Discussion</a></li>
                        <li><a href="#">Clinical Impression</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Plan<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Re-evaluation</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Old Records</a></li>
                        <li><a href="#">Critical Care</a></li>
                        <li><a href="#">Addendum</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
